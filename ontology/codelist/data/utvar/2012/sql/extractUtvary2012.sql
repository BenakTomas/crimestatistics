...
into outfile 'C:\\Documents and Settings\\Tom\\Plocha\\bcPrace\\new\\ontology\\codelists\\final\\data\\utvar\\2012\\okresy\\okresy_actual.csv'
character set utf8
...
load data local infile 'C:\\Documents and Settings\\Tom\\Plocha\\bcPrace\\new\\ontology\\codelists\\final\\data\\utvar\\2012\\utvary\\utvary_actual.csv'
replace
...
select
	k.kr, '00', '', k.nazev, '0', ''
from kraje k
into outfile 'C:\\Documents and Settings\\Tom\\Plocha\\bcPrace\\new\\ontology\\codelists\\final\\data\\utvar\\2012\\kraje\\kraje_final.csv'
character set utf8
fields terminated by '#'
lines terminated by '\n';
...
into outfile 'C:\\Documents and Settings\\Tom\\Plocha\\bcPrace\\new\\ontology\\codelists\\final\\data\\utvar\\2012\\centralni_utvary_final.csv'
character set utf8
fields terminated by '#'
lines terminated by '\n';
...
select
	oa.kr, oa.ok, '', oa.nazev, 1, ''
from okresy_actual oa
into outfile 'C:\\Documents and Settings\\Tom\\Plocha\\bcPrace\\new\\ontology\\codelists\\final\\data\\utvar\\2012\\okresy\\okresy_final.csv'
character set utf8
fields terminated by '#'
lines terminated by '\n';
...
from utvary_toOkresy uto
into outfile 'C:\\Documents and Settings\\Tom\\Plocha\\bcPrace\\new\\ontology\\codelists\\final\\data\\utvar\\2012\\utvary\\utvary_toOkresy_final.csv'
character set utf8
fields terminated by '#'
lines terminated by '\n';
...
into outfile 'C:\\Documents and Settings\\Tom\\Plocha\\bcPrace\\new\\ontology\\codelists\\final\\data\\utvar\\2012\\utvary\\utvary_toKraje_final.csv'
character set utf8
fields terminated by '#'
lines terminated by '\n';
...
from utvary_toCentralniUtvary utcu
into outfile 'C:\\Documents and Settings\\Tom\\Plocha\\bcPrace\\new\\ontology\\codelists\\final\\data\\utvar\\2012\\utvary\\utvary_toCentralniUtvary_final.csv'
character set utf8
fields terminated by '#'
lines terminated by '\n';